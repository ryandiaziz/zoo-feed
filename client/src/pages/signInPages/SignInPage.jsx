        ...
        <div>
            {
                props.isSignIn &&
                <>
                    <div className='border-2 border-red-400 fixed z-30 font-noto w-full h-full flex justify-center overflow-auto'>
                        <div className='w-1/3'>
                            <div className='bg-red-300 w-10 h-80' />
                            <div className="border-2 border-red-400 h-min bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 relative">
